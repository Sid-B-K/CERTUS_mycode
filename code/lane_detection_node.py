...
class LaneDetectionNode:
    ...
    def publish_waypoints(self, middle_lane):
        ...
        marker.id = 0  # Only one waypoint at a time
    ...
    def has_reached_waypoint(self, x_proj, y_proj):
        ...
        # Update vehicle_x, vehicle_y using the vehicle's current pose from your setup
        vehicle_x, vehicle_y = 0, 0  # Placeholder - update with actual vehicle coordinates

        distance = np.sqrt((vehicle_x - x_proj) ** 2 + (vehicle_y - y_proj) ** 2)
